...
function getGrade(tons) {
  ...
  if (tons <= 4.0) return { grade: "A",  label: "Great",     color: "#047857" };
  if (tons <= 6.0) return { grade: "B",  label: "Good",      color: "#059669" };
  if (tons <= 8.0) return { grade: "B-", label: "Average",   color: "#C2410C" };
  if (tons <= 12.0) return { grade: "C", label: "Above Avg", color: "#B45309" };
  if (tons <= 16.0) return { grade: "D", label: "High",      color: "#B91C1C" };
  return { grade: "F", label: "Very High", color: "#991B1B" };
}
